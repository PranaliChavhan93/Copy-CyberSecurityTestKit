...
function WiresharkParameters({
                ...
                if (response.ok) {
                    setOutput(
                        (prev) =>
                            ...
                            `${
                                data.output ||
                                "Wireshark GUI opened successfully"
                            }\n`
                    );
    ...
    const handleDownload = () => {
        if (
            ...
            alert(
                "No output available! Please run the capture first."
            );
            return;
        }
    ...
    return (
        <div className="tool-box">
            ...
            <div className="tool-form">
                ...
                <div className="tool-field">
                    ...
                    <input
                        ...
                        value={captureFilter}
                        onChange={(e) =>
                            setCaptureFilter(e.target.value)
                        }
                    />
                    <small>
            ...
            <div className="tool-options">
                <h4>
                    Traffic Generation (TShark Mode)
                </h4>
