...
// // import Amass from "./pages/Tester/Testing.jsx";
// import Testing from "./pages/Tester/Testing.jsx";

// import ProjectsOFTM from "./pages/TestManager/TMProjects.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Testing - Project Selection (when clicking menu) */}
        <Route path="/tester/testing" element={
          <Layout>
            <TestingProjectList />
          </Layout>
        ...
        {/* Testing - Individual Project with Stage */}
        <Route path="/tester/testing/:projectId/:stage" element={
            <Layout>
                <Testing />
            </Layout>
        ...
        <Route path="/tester/testing/:projectId/:stage" element={<Layout><Testing /></Layout>} />
